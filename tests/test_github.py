...
from lftools.cli import github
from lftools import github
from lftools.github import GitHub, requests
...
#    mock_github = mocker.patch('lftools.github.cmd.libgh')
#    mock_user = mocker.patch('lftools.github.cmd.libgh.AuthenticatedUser')
#    mock_repo_object = mocker.patch('lftools.github.cmd.libgh.Repository.Repository')
...
#    mock_github.Github.get_user.get_repo.protect_branch.assert_called_with(name,
#                                                       enabled,
#                                                       contexts=contexts,
...
def test_list_org_members('edgexfoundry'):
    _github = GitHub