...
#TODO AGL DOES NOT REPLICATE TO GITHUB, make a flag
#TODO parse and add project lead to review
#TODO nexus2 lf-tools (releng tools?) take a yaml file
#old docs https://pdx-caf-support.int.codeaurora.org/wiki/sop/collab-subproj-depl
#add docker hub repos?
#JIRA make project, add permissions
