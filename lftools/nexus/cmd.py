...
# already released lftools nexus release -v --server https://nexus.opendaylight.org mdsal-1741
# pom errors lftools nexus release -v --server https://nexus.opendaylight.org honeycomb-vbd-1629
