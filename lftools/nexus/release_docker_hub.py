...
class DockerTagClass(TagClass):
    ...
    def __init__(self, org_name, repo_name, repo_from_file):
        ...
        if r.status_code == 429:
            ...
            raise requests.HTTPError("Throttling in effect. {} Docker pulls so far. You need to wait {} hours and possible reduce scope. \n{}".format(len(projects), throttling_delay_hours, r.text))
...
def start_point(
    ...
    anonymous_throttling_after = AnonymousThrottlingStatus()
    if verbose:
