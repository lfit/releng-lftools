...
def deploy_s3(s3_bucket, s3_path, build_url, workspace, pattern=None):
    ...
    try:
        ...
        log.info("Creating Dummy Files")
        open("test.txt", "a").close()
        log.info("Uploading Dummy Files")
        ...
        log.info("Deleting Dummy Files")
        s3.Object(s3_bucket, "{}{}".format(s3_silo, "test.txt")).delete()
        s3.Object(s3_bucket, "{}{}{}".format(s3_silo, s3_jenkins_host, "test.txt")).delete()
    else:
        return True
