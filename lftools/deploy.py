...
def deploy_s3(s3_bucket, s3_path, build_url, workspace, pattern=None):
    ...
    def _deploy_s3_upload(file):
        ...
        if mimetypes.guess_type(file)[0] == None and mimetypes.guess_type(
                file)[1] == None:
    ...
    file_list = []
    log.info('Uploading files from {} to {}/{}'.format(work_dir, s3_bucket,
                                                       s3_path))
    ...
    #log.info("Uploaded in {} seconds.".format(
    #    timedelta(seconds=round(upload_time))))
