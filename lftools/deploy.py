...
def deploy_s3(s3_bucket, s3_path, build_url, workspace, pattern=None):
    ...
    s3.Bucket(s3_bucket).upload_file("jenkins_host", "{}{}".format(s3_jenkins_host, "jenkins_host"))
    ...
    os.chdir(previous_dir)
    shutil.rmtree(work_dir)
    # s3.Object(s3_bucket, "{}{}".format(s3_silo, "silo")).delete()
    # s3.Object(s3_bucket, "{}{}{}".format(s3_silo, s3_jenkins_host, "jenkins_host")).delete()
