...
class Gerrit:
    ...
    def __init__(self, **params):
        ...
        remote = "https://{}:{}@{}/r/a/{}".format(
            self.params["creds"]["username"], self.params["creds"]["password"], self.fqdn, self.project
        )
    ...
    def add_info_job(self, fqdn, gerrit_project, issue_id):
        ...
        content = template.render(
            project_name_dashed=gerrit_project_dashed, project_name=gerrit_project, buildnode=buildnode
        )
    ...
    def add_git_review(self, fqdn, gerrit_project, issue_id):
        ...
        content = template.render(fqdn=fqdn, project_name=gerrit_project)
