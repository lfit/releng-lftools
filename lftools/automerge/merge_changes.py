...
""" This python script automates a part of release workflow used for merging
...
ex: merge_changes.py -u abelur -to Boron-SR2

"""

# TODO:
# Improve documentation/usage
# Determine how to filter the stream-events on given topic
...
def _main():
    ...
    try:
        ...
        for j in jdata:
            logging.debug("project: %s commit: %s", j['project'],
