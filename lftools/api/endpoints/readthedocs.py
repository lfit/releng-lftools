...
class ReadTheDocs(client.RestApi):
    ...
    def project_version_list(self, project):
        ...
        result = self.get('projects/{}/versions/?active=True'.format(project))[1]  # NOQA
        more_results = None
        versions = []
    ...
    def project_version_details(self, project, version):
        ...
        result = self.get('projects/{}/versions/{}/'.format(project, version))[1]  # NOQA
        return result
    ...
    def project_create(self, name, repository_url, repository_type, homepage,
        ...
        json_data = json.dumps(data)
        result = self.post('projects/', data=json_data, **kwargs)  # NOQA
        return result

    def project_build_list(self, project, **kwargs):
        """
        Retrieves the project's running build list
        ...
        result = self.get('projects/{}/builds/?running=True'.format(project), **kwargs)[1] # NOQA
    ...
    def project_build_details(self, project, build_id, **kwargs):
        ...
        result = self.get('projects/{}/builds/{}/'.format(project, build_id))[1]  # NOQA
        return result
    ...
    def project_build_trigger(self, project, version):
        ...
        result = self.post('projects/{}/versions/{}/builds/'.format(project, version))[1]  # NOQA
        return result
