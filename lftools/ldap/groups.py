...
def create_ldap_groups_ids(config_file, secure_settings_file):
    """Create LDAP groups.
    ...
    :arg str secure_settings_file: Config file containing LDAP administrative settings
    """
    # open our settings file
    with open(secure_settings_file, 'r') as f:
