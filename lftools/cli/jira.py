...
@click.pass_context
def create_project(ctx, notificationscheme, lead, url, projecttemplatekey, longname, shortkey):
    ...
    Example:
    lftools jira create-project 10000 agardner jira.opnfv.org com.pyxis.greenhopper.jira:gh-scrum-template "Aric test project" ARICTEST
    """
    userAndPass = config.get_setting("jira", "base64")
