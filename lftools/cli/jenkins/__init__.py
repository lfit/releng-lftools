...
# Don't confuse this with the function ...
import jenkins as jenkins_python
from urllib2 import HTTPError

from lftools.cli.jenkins.plugins import plugins
...
def jenkins_cli(ctx, server, user, password):
    ...
    ctx.obj['server'] = jenkins_python.Jenkins(server,
            username=user,
            password=password)
...
jenkins_cli.add_command(plugins)
