...
@click.option(
    ...
    default="",
    required=False,
    help="Which S3 bucket to use for permanent data storage.",
)
@click.pass_context
def copy_from_nexus3_to_dockerhub(
    ctx, org, repo, exact, summary, verbose, copy, progbar, repofile, version_regexp, ignorethrottledelay, s3_bucket_name,
):
    ...
    """
    rdh.start_point(org, repo, exact, summary, verbose, copy, progbar, repofile, version_regexp, ignorethrottledelay, s3_bucket_name)
