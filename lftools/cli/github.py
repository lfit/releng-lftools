...
def org_team_member_audit(ctx, organization, admin_config):
    """Audit team membership of an organization"""
...
def list_repo_collaborators(ctx, organization, repository, admin_config):
    """Audit collaborators of an organizations repository"""
...
@click.option('-r', '--repository', type=str, required=True,
              help="Name of the repository.")
@click.pass_context
def list_repo_contributors(ctx, organization, repository, admin_config):
    """Audit contributors of an organizations repository"""
    githubcmd.get_repo_contributors(organization, repository, admin_config)
...
@click.option('-o', '--organization', type=str, required=True,
              help="Name of the Github organzation.")
@click.pass_context
def org_repo_audit(ctx, organization, admin_config):
    """Audit repositories of an organization"""
    githubcmd.org_repo_audit(organization, admin_config)
...
github.add_command(org_repo_audit)
