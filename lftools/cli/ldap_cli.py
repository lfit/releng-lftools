...
def main():
    ...
    for group in group_dict:
        ...
        for user in group['members']:
            user_info = ldap_query(l, LDAP_USER_BASE_DN, user, ["uid", "cn", "mail"])
            try:
