...
@click.option('--groups', default=['opnfv-gerrit-releng-submitters'], envvar='groups', type=str, required=True)

@click.pass_context
def ldap_cli(ctx, ldapserver, ldapgroupbase, ldapuserbase, groups):
