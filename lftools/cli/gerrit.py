...
def checkproject(ctx, gerrit_url, gerrit_project):
    ...
    list = [ 'projects/', 'projects/{}'.format(gerrit_project_encoded) ]
    ...
    access_str = 'projects/{}'.format(gerrit_project_encoded)

#    access_str = '/changes/68739'
#    result = rest.get(access_str, headers=headers)
#    print(result)
    ...
    #result = rest.post(access_str, headers=headers)
    print(result)
