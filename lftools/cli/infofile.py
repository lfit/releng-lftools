...
def check_votes(ctx, info_file, gerrit_url, change_number):
    ...
    print("Number of Committers:")
    print(len(info_committers))
    committer_lenght = (len(info_committers))

    print("Committers have voted:")
    print(have_voted)
    print(have_voted_length)
    print("Committers that have not voted:")
    print(have_not_voted)
    print(have_not_voted_length)

    majority = (committer_lenght / have_voted_length)
    if (majority == 1):
        print("majority vote reached")
        sys.exit(0)
    else:
        print("majority not yet reached")
        sys.exit(1)
