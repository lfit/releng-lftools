...
// I don't think I need this anymore. Leaving it here since I am not sure yet. 
...
def mapConfig = { project ->
    ...
    c2 = new MavenSettingsConfig("${project}-settings", "${project}-settings", "${project}-settings", c1.content, MavenSettingsConfig.isReplaceAllDefault, mappings);
